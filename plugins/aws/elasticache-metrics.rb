...
#   By default fetches all available statistics from one minute ago.
#   You may need to fetch further back than this;
#
# LICENSE:
...
class ElastiCacheMetrics < Sensu::Plugin::Metric::CLI::Graphite
  ...
  option :aws_access_key,
         ...
         description: "AWS Access Key. Either set ENV['AWS_ACCESS_KEY_ID'] or \
         provide it as an option"

  option :aws_secret_access_key,
         short: '-k AWS_SECRET_ACCESS_KEY',
         long: '--aws-secret-access-key AWS_SECRET_ACCESS_KEY',
         description: "AWS Secret Access Key. Either \
         set ENV['AWS_SECRET_ACCESS_KEY'] or provide it as an option"
